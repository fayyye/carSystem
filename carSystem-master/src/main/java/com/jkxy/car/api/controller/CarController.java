...
public class CarController {
     ...
     * @return
     */
    @GetMapping("findByCarNameAndPage/{carName}/{start}/{end}")
    public JSONResult selectByCarNameAndPage(@PathVariable String carName,@PathVariable int start,@PathVariable int end){
        List<Car> cars=carService.selectByCarNameAndPage(carName,start,end);
        return JSONResult.ok(cars);
    }
}
